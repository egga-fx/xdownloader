    ...
    <div className="w-full bg-[#121215] border border-[#27272a] rounded-2xl p-4 sm:p-5 flex flex-col gap-4 shadow-xl shadow-black/50">
          ...
          <div className="flex items-center gap-1.5 mt-3">
            {info.description === "image" ? (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold bg-amber-600 text-white shadow-sm shadow-amber-600/30 cursor-pointer"
              >
                <ImageIcon className="w-3.5 h-3.5" />
                <span>Photo / Carousel (HD)</span>
              </button>
            ) : (
              <>
                <button
      ...
      <div className="pt-3 border-t border-[#27272a] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          {isImage ? (
            <span className="px-2.5 py-1 rounded-md text-xs font-bold uppercase bg-amber-500/20 text-amber-400 border border-amber-500/50">
          ...
          <button
            ...
            className={`flex-1 sm:flex-none px-6 py-2.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 cursor-pointer transition-all ${
              isDownloadingCurrentUrl
                ...
                : isImage
                ? "bg-amber-600 hover:bg-amber-500 text-white shadow-lg shadow-amber-600/30 active:scale-98"
          ...
          >
            {isDownloadingCurrentUrl ? (
              ...
              <>
                ...
                <span>
                  Download {isImage ? "Image / Carousel" : formatType === "audio" ? "Audio" : "Video"}
                </span>
              </>
            )}
          </button>
